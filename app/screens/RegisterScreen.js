    ...
    >
      ...
      >
        ...
        <View style={styles.brandBlock}>
          ...
          <Text style={styles.tagline}>Beta Access</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.fieldLabel}>Beta Access Code</Text>
          <TextInput
            style={styles.input}
        ...
        >
          <Text style={styles.footerText}>
            ...
            <Text style={styles.footerTextAccent}>Sign In</Text>
          </Text>
        </TouchableOpacity>
